...
public class MovingTests(ITestOutputHelper output) : IDisposable
{
    ...
    /// </summary>
    [Fact]
    public async Task Move_LeftToRightFromParentToAnotherParentWithGapBeforeAfterAndBetween_ValidHierarchy()
    {
        // Arrange
        using (var context = factory.CreateDbContext())
        {
    ...
    /// </summary>
    [Fact]
    public async Task Move_RightToLeftFromParentToAnotherParentWithGapBeforeAfterAndBetween_ValidHierarchy()
    {
        // Arrange
        using (var context = factory.CreateDbContext())
        {
